const ALGEBRA_QUESTIONS = (() => {
  ...
  function buildSystemEquationQuestion(difficulty) {
    ...
    return buildGeneratedEntry({
      ...
      answer,
      distractors: [`x = ${y}, y = ${x}`, `x = ${x + 1}, y = ${y + 1}`, `x = ${x - 1}, y = ${y + 1}`],
      difficulty,
  ...
  const fallbackQuestions = [
    ...
    makeEntry({
      question: "What number goes in the blank? 6 + __ = 11",
      answer: 5,
      options: ["4", "5", "6", "7"],
      difficulty: 1,
      family: "missing-addend",
    ...
    makeEntry({
      question: "What number goes in the blank? 14 - __ = 8",
      answer: 6,
      options: ["5", "6", "7", "8"],
      difficulty: 1,
      family: "missing-subtraction",
    ...
    makeEntry({
      question: "Rule: add 1. If the input is 8, what is the output?",
      answer: 9,
      options: ["8", "9", "10", "11"],
      difficulty: 1,
      family: "function-table",
    ...
    makeEntry({
      question: "What number goes in the blank? 5 x __ = 35",
      answer: 7,
      options: ["6", "7", "8", "9"],
      difficulty: 2,
      family: "blank-multiply",
    ...
    makeEntry({
      question: "What number goes in the blank? __ divided by 4 = 6",
      answer: 24,
      options: ["20", "22", "24", "28"],
      difficulty: 2,
      family: "blank-divide",
    ...
    makeEntry({
      question: "Rule: add 2. If the input is 9, what is the output?",
      answer: 11,
      options: ["10", "11", "12", "18"],
      difficulty: 2,
      family: "function-table",
    ...
    makeEntry({
      question: "What comes next: 4, 10, 16, 22, __?",
      answer: 28,
      options: ["26", "27", "28", "30"],
      difficulty: 3,
      family: "number-pattern",
    ...
    makeEntry({
      question: "Rule: multiply the input by 2, then add 1. If the input is 5, what is the output?",
      answer: 11,
      options: ["10", "11", "12", "15"],
      difficulty: 3,
      family: "function-table",
    ...
    makeEntry({
      question: "What is x if 2(x + 3) = 16?",
      answer: 5,
      options: ["4", "5", "6", "8"],
      difficulty: 5,
      family: "two-step-parentheses",
    ...
    makeEntry({
      question: "Which expression is the same as 3(x - 4)?",
      answer: "3x - 12",
    ...
    makeEntry({
      question: "What is x if 6(x + 2) = 48?",
      answer: 6,
      options: ["5", "6", "7", "8"],
      difficulty: 6,
      family: "distribute-solve",
    ...
    makeEntry({
      question: "If x = 5 and y = 3, what is 4x + 3y?",
      answer: 29,
      options: ["23", "26", "29", "35"],
      difficulty: 6,
      family: "two-variable-substitution",
    ...
    makeEntry({
      question: "What is x if 7x = 3x + 32?",
      answer: 8,
      options: ["6", "7", "8", "9"],
      difficulty: 6,
      family: "variables-both-sides",
    ...
    makeEntry({
      question: "Which expression is the same as 7x + 2x + 6?",
      answer: "9x + 6",
      options: ["9x + 6", "14x + 6", "15x", "9x"],
      difficulty: 6,
      family: "combine-like-terms",
    }),
    makeEntry({
    ...
    makeEntry({
      question: "What is x if x/5 + 4 = 11?",
      answer: 35,
      options: ["25", "30", "35", "40"],
      difficulty: 7,
      family: "fraction-coefficient",
    ...
    makeEntry({
      question: "Which describes the solutions to x + 9 > 17?",
      answer: "x > 8",
      options: ["x > 8", "x < 8", "x = 8", "x > 26"],
      difficulty: 7,
      family: "inequality",
    }),
    makeEntry({
      question: "What is x if 3x + 2 = -13?",
      answer: -5,
      options: ["-5", "5", "-3", "3"],
      difficulty: 7,
      family: "negative-solution",
    ...
    makeEntry({
      question: "If x = -3 and y = 4, what is 4x + 3y?",
      answer: 0,
      options: ["-24", "-8", "0", "8"],
      difficulty: 7,
      family: "two-variable-substitution",
    ...
    makeEntry({
      question: "What is the slope of the line through (0, 2) and (3, 11)?",
      answer: 3,
      options: ["2", "3", "4", "9"],
      difficulty: 8,
      family: "slope",
    ...
    makeEntry({
      question: "If f(x) = 4x + 1, what is f(6)?",
      answer: 25,
      options: ["23", "24", "25", "26"],
      difficulty: 8,
      family: "function-notation",
    ...
    makeEntry({
      question: "The 1st term is 7. Add 4 each time. What is the 7th term?",
      answer: 31,
      options: ["27", "28", "31", "35"],
      difficulty: 8,
      family: "sequence-formula",
    ...
    makeEntry({
      question: "What is x if 6(x + 1) = 42?",
      answer: 6,
      options: ["5", "6", "7", "8"],
      difficulty: 8,
      family: "distribute-solve",
    ...
    makeEntry({
      question: "Solve the system: x + y = 11, x - y = 5.",
      answer: "x = 8, y = 3",
      options: ["x = 8, y = 3", "x = 3, y = 8", "x = 11, y = 5", "x = 16, y = 6"],
      difficulty: 9,
      family: "system-equations",
    }),
    makeEntry({
      question: "Which expression is a factorization of x^2 + 9x + 20?",
      answer: "(x + 4)(x + 5)",
      options: ["(x + 4)(x + 5)", "(x + 9)(x + 20)", "(x - 4)(x - 5)", "(x + 2)(x + 10)"],
      difficulty: 9,
      family: "factor-quadratic",
    }),
    makeEntry({
      question: "Which expression is equal to a^2 * a^5?",
      answer: "a^7",
      options: ["a^7", "a^10", "a^3", "7a"],
      difficulty: 9,
      family: "exponent-rules",
    }),
    makeEntry({
      question: "What is the slope of the line through (1, 10) and (4, 4)?",
      answer: -2,
      options: ["-2", "2", "-6", "6"],
      difficulty: 9,
      family: "slope",
    ...
    makeEntry({
      question: "Solve the system: 2x + y = 19, x + y = 11.",
      answer: "x = 8, y = 3",
      options: ["x = 8, y = 3", "x = 3, y = 8", "x = 9, y = 2", "x = 19, y = 11"],
      difficulty: 10,
      family: "system-equations",
    }),
    makeEntry({
      ...
      answer: "4 and 5",
      options: ["4 and 5", "-4 and -5", "9 and 20", "2 and 10"],
      difficulty: 10,
      family: "quadratic-roots",
    }),
    makeEntry({
    ...
    makeEntry({
      question: "Which expression is a factorization of x^2 + 13x + 42?",
      answer: "(x + 6)(x + 7)",
      options: ["(x + 6)(x + 7)", "(x + 13)(x + 42)", "(x - 6)(x - 7)", "(x + 3)(x + 14)"],
      difficulty: 10,
      family: "factor-quadratic",
    }),
  ];
