(() => {
  ...
  const blueprints = [
    ...
    { topic: "science-weather", difficulty: 8, question: "What does a falling barometer often suggest?", answer: "Changing or stormier weather may be coming", options: ["Changing or stormier weather may be coming", "The Moon is closer", "Rocks are melting", "All clouds disappear"] },
