...
const HEBREW_SENTENCE_NIKKUD_OVERRIDES = {
  ...
  "מדובר": "מְדֻבָּר",
  "ארוכה": "אֲרֻכָּה",
  // Reviewed forms used by the extended reading, sentence-building, and
  // evidence-literacy questions. Keep homographs that depend on context as
  // full-sentence overrides below instead of assigning one misleading form.
  "המרכזית": "הַמֶּרְכָּזִית",
  "בו": "בּוֹ",
  "הדברים": "הַדְּבָרִים",
  "המשיכה": "הִמְשִׁיכָה",
  "לעשות": "לַעֲשׂוֹת",
  ...
  "הוכיח": "הוֹכִיחַ",
  "חייב": "חַיָּב",
  "להשתמש": "לְהִשְׁתַּמֵּשׁ",
  "צורך": "צוֹרֶךְ",
  "אילו היו הנתונים שלמים יותר, החוקרים ___ מסקנה מדויקת יותר.":
    "אִלּוּ הָיוּ הַנְּתוּנִים שְׁלֵמִים יוֹתֵר, הַחוֹקְרִים ___ מַסְקָנָה מְדֻיֶּקֶת יוֹתֵר.",
  "אילו היו הנתונים שלמים יותר, החוקרים היו מסיקים מסקנה מדויקת יותר.":
    "אִלּוּ הָיוּ הַנְּתוּנִים שְׁלֵמִים יוֹתֵר, הַחוֹקְרִים הָיוּ מַסִּיקִים מַסְקָנָה מְדֻיֶּקֶת יוֹתֵר.",
  "דנה שמה לב שהמחקר כלל רק עשרה תלמידים ולא הייתה בו קבוצת השוואה.":
    "דָּנָה שָׂמָה לֵב שֶׁהַמֶּחְקָר כָּלַל רַק עֲשָׂרָה תַּלְמִידִים וְלֹא הָיְתָה בּוֹ קְבוּצַת הַשְׁוָאָה.",
  "במהלך": "בְּמַהֲלָךְ",
  "החשובים": "הַחֲשׁוּבִים",
  "קצרה": "קְצָרָה",
  "אותנו": "אוֹתָנוּ",
  "בדיוק": "בְּדִיּוּק",
  "צריך": "צָרִיךְ",
  "מדי": "מִדַּי",
  "יהיה": "יִהְיֶה",
  "שהמכשיר": "שֶׁהַמַּכְשִׁיר",
  "אלא": "אֶלָּא",
  "המקומות": "הַמְּקוֹמוֹת",
  "אחראי": "אַחְרָאִי",
  "הציע": "הִצִּיעַ",
  "דקות": "דַּקּוֹת",
  "החדשים": "הַחֲדָשִׁים",
