(() => {
  ...
  sessionCustomization: document.getElementById("session-customization"),
  speedChallengeEnabled: document.getElementById("speed-challenge-enabled"),
  speedSoundEnabled: document.getElementById("speed-sound-enabled"),
  speedRelaxedTimer: document.getElementById("speed-relaxed-timer"),
  resumeSessionPanel: document.getElementById("resume-session-panel"),
  resumeSessionSummary: document.getElementById("resume-session-summary"),
  resumeSessionButton: document.getElementById("resume-session-button"),
  ...
  practicePresetButton: document.getElementById("practice-preset-button"),
  practiceTopicPanel: document.getElementById("practice-topic-panel"),
  practiceTopicGroups: document.getElementById("practice-topic-groups"),
  practiceTopicSelection: document.getElementById("practice-topic-selection"),
  difficultyLabel: document.getElementById("difficulty-label"),
  difficultySelector: document.getElementById("difficulty-selector"),
  difficultyLevel: document.getElementById("difficulty-level"),
  difficultyValue: document.getElementById("difficulty-value"),
  difficultyScope: document.getElementById("difficulty-scope"),
  ...
  screenStatusAnnouncer: document.getElementById("screen-status-announcer"),
  ...
  resultsPracticeButton: document.getElementById("results-practice-button"),
  ...
  appUpdateLaterButton: document.getElementById("app-update-later-button"),
};
  }
