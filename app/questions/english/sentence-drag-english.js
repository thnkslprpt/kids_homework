const SENTENCE_DRAG_ENGLISH_DATA = (() => {
  ...
  const STATIC_BLUEPRINTS = [
    ...
    [1, "Complete the sentence in the simple past tense.", ["The boy ", " the red ball."], ["kicked"], ["kick", "kicks", "kicking"]],
    [1, "Complete the sentence in the simple present tense.", ["The bird ", " in the tree."], ["sits"], ["sit", "sitting", "sat"]],
    ...
    [1, "Complete the sentence in the simple present tense.", ["The children ", " outside after lunch."], ["play"], ["plays", "playing", "played"]],

    [1, "Complete the sentence in the simple present tense.", ["A fish ", " in the pond."], ["swims"], ["swim", "swimming", "swam"]],
    [1, "Complete the sentence.", ["I can see ", " moon in the sky."], ["the"], ["they", "then", "them"]],
    [1, "Complete the sentence in the simple past tense.", ["The girl ", " her hands before lunch."], ["washed"], ["wash", "washing", "washes"]],
    [1, "Choose the best describing word.", ["The pillow feels ", "."], ["soft"], ["loud", "tall", "wet"]],
    [1, "Complete the sentence in the simple present tense.", ["The ducks ", " across the pond."], ["swim"], ["swims", "swimming", "swam"]],
    ...
    [1, "Complete the sentence in the simple present tense.", ["The sun ", " in the morning."], ["rises"], ["rise", "rising", "rose"]],
    ...
    [2, "Complete the sentence in the simple present tense.", ["The fox ", " near the fence."], ["runs"], ["run", "running", "ran"]],
    ...
    [2, "Complete the sentence in the simple present tense.", ["The dogs ", " loudly when the bell rings."], ["bark"], ["barks", "barking", "barked"]],
  ...
  function createAgreementEntry(difficulty) {
    ...
    return createEntry({
      question: "Complete the sentence in the simple present tense.",
