const SCIENCE_EVIDENCE_QUESTIONS = [
  ...
  scienceEvidenceBuildQuestion({
    question: "Which choice is a measurement?",
    displayText: "A student records information about a small rock.",
    options: [
      "The rock is 5 cm long",
      "The rock is nice",
      "The rock is lucky",
      "The rock is my favorite",
    ],
    answer: "The rock is 5 cm long",
    difficulty: 1,
    visualSummary: "A measurement uses a number and unit.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What should stay the same in this fair test?",
    displayText: "A class tests which cup keeps water coldest. Each cup starts with cold water.",
    options: [
    ...
    difficulty: 1,
    visualSummary: "The water amount should stay the same when comparing cups.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What variable changed in the test?",
    displayText: "Group A plants get plain water. Group B plants get water with plant food.",
    options: [
      "Whether plant food is added",
      "The plant name",
      "The ruler color",
      "The day of the week",
    ],
    answer: "Whether plant food is added",
    difficulty: 1,
    visualSummary: "Plant food is the thing that changes between the groups.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence best supports the claim?",
    displayText: "Claim: The red ball bounced higher than the blue ball. Data: Red ball = 45 cm. Blue ball = 30 cm.",
    options: [
      "The red ball bounced 45 cm and the blue ball bounced 30 cm",
      "Both balls were round",
      "The blue ball was blue",
      "The test was done in class",
    ],
    answer: "The red ball bounced 45 cm and the blue ball bounced 30 cm",
    difficulty: 1,
    visualSummary: "The red ball has the higher bounce height.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which tool would best measure how much water is in a cup?",
    displayText: "A student needs to record the amount of water used in an experiment.",
    options: [
      "A measuring cup",
      "A magnet",
      "A thermometer",
    ...
    difficulty: 1,
    visualSummary: "A measuring cup measures liquid volume.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which sentence is an observation?",
    displayText: "A student looks at a candle after it has burned for five minutes.",
    options: [
      "The candle is shorter than before",
      "The candle wanted to shrink",
      "The candle is happier now",
      "The candle is the best one",
    ],
    answer: "The candle is shorter than before",
    difficulty: 1,
    visualSummary: "An observation describes what can be seen or measured.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which question can be tested with evidence?",
    displayText: "A class wants to do a simple science investigation.",
    options: [
      "Which paper airplane flies the farthest?",
      "Which airplane is the coolest?",
      "Which color feels brave?",
      "Which airplane has the nicest name?",
    ],
    answer: "Which paper airplane flies the farthest?",
    difficulty: 1,
    visualSummary: "Flying distance can be measured.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which result supports the claim?",
    displayText: "Claim: The cloth bag held more pennies than the paper bag. Data: Cloth bag = 40 pennies. Paper bag = 18 pennies.",
    options: [
      "The cloth bag held 40 pennies and the paper bag held 18 pennies",
      "Both bags had handles",
      "Pennies are round",
      "The paper bag was brown",
    ],
    answer: "The cloth bag held 40 pennies and the paper bag held 18 pennies",
    difficulty: 1,
    visualSummary: "The cloth bag held more pennies in the data.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Which conclusion is best from the data?",
    displayText: "Water absorbed by towels:\nYellow towel: 9 mL\nPurple towel: 14 mL\nWhite towel: 11 mL",
    options: [
      "The purple towel absorbed the most water",
      "The yellow towel absorbed the most water",
      "All towels absorbed the same amount",
      "No towel absorbed water",
    ],
    answer: "The purple towel absorbed the most water",
    difficulty: 2,
    visualSummary: "14 mL is the greatest amount.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What should the student keep the same?",
    displayText: "A student tests whether sugar or salt dissolves faster in water.",
    options: [
      "The amount of water in each cup",
      "Whether sugar or salt is used",
      "The time it takes to dissolve",
      "The result written at the end",
    ],
    answer: "The amount of water in each cup",
    difficulty: 2,
    visualSummary: "Water amount should be controlled while the substance changes.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What does the data show?",
    displayText: "Seed height:\nDay 1: 1 cm\nDay 4: 3 cm\nDay 7: 6 cm",
    options: [
      "The seedling grew taller over time",
      "The seedling got shorter over time",
      "The seedling stayed 1 cm tall",
      "The seedling turned into a cup",
    ],
    answer: "The seedling grew taller over time",
    difficulty: 2,
    visualSummary: "The height increases from 1 cm to 6 cm.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which part is the outcome being measured?",
    displayText: "A class changes the amount of exercise a toy wind-up car gets and measures how far it travels.",
    options: [
      "How far the car travels",
      "How much the car is wound",
      "The color of the car",
      "The name of the class",
    ],
    answer: "How far the car travels",
    difficulty: 2,
    visualSummary: "Distance traveled is the measured outcome.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence supports the claim?",
    displayText: "Claim: The metal spoon felt colder than the wooden spoon after both were placed in ice water.",
    options: [
      "Students recorded that the metal spoon felt colder",
      "Both spoons were on the table",
      "The wooden spoon was brown",
      "Ice water was in a cup",
    ],
    answer: "Students recorded that the metal spoon felt colder",
    difficulty: 2,
    visualSummary: "The recorded comparison supports the claim.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which action would make the test unfair?",
    displayText: "Two paper airplanes are tested to see which flies farther.",
    options: [
      "Throw one airplane harder than the other",
      "Measure both flights in meters",
      "Use the same starting line",
      "Test both in the same hallway",
    ],
    answer: "Throw one airplane harder than the other",
    difficulty: 2,
    visualSummary: "Changing the throwing force adds another variable.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement compares the data correctly?",
    displayText: "Cooling test after 10 minutes:\nCup with lid: 42\u00b0C\nCup without lid: 36\u00b0C",
    options: [
      "The cup with the lid stayed warmer",
      "The cup without the lid stayed warmer",
      "Both cups were 36\u00b0C",
      "No temperature was measured",
    ],
    answer: "The cup with the lid stayed warmer",
    difficulty: 2,
    visualSummary: "42\u00b0C is warmer than 36\u00b0C.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which notebook entry is useful evidence?",
    displayText: "A student watches a snail move across a tile.",
    options: [
      "The snail moved 30 cm in 2 minutes",
      "The snail is adorable",
      "The tile is boring",
      "The snail likes racing",
    ],
    answer: "The snail moved 30 cm in 2 minutes",
    difficulty: 2,
    visualSummary: "A useful entry records measured evidence.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Which plan makes this a fair test?",
    displayText: "A student compares two soaps to see which removes a grass stain better.",
    options: [
      "Use the same stain size and wash time for both soaps",
      "Use a bigger stain for one soap",
      "Wash one cloth longer than the other",
      "Choose the winner before washing",
    ],
    answer: "Use the same stain size and wash time for both soaps",
    difficulty: 3,
    visualSummary: "Only the soap should change in the comparison.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence supports the claim?",
    displayText: "Claim: A fan makes wet paper dry faster. Data: With fan = 8 minutes. No fan = 20 minutes.",
    options: [
      "The paper with the fan dried in less time",
      "Both papers were white",
      "The fan had three blades",
      "The paper was on a desk",
    ],
    answer: "The paper with the fan dried in less time",
    difficulty: 3,
    visualSummary: "A shorter drying time supports the claim.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What conclusion fits the data?",
    displayText: "Seed test after 7 days:\nWatered daily: 9 cm\nNot watered: 2 cm",
    options: [
      "The watered seedling grew taller in this test",
      "The dry seedling grew taller",
      "Water stopped growth",
      "Both seedlings were exactly equal",
    ],
    answer: "The watered seedling grew taller in this test",
    difficulty: 3,
    visualSummary: "9 cm is taller than 2 cm.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement is an observation, not an inference?",
    displayText: "A student examines an unknown powder.",
    options: [
      "The powder is white",
      "The powder is probably sugar",
      "The powder wants water",
      "The powder is magic",
    ],
    answer: "The powder is white",
    difficulty: 3,
    visualSummary: "White is something the student can observe.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which variable should be changed on purpose?",
    displayText: "A class tests whether cup material affects how long ice stays frozen.",
    options: [
      "Cup material",
      "Amount of ice",
      "Starting ice size",
    ...
    answer: "Cup material",
    difficulty: 3,
    visualSummary: "Cup material is the variable being tested.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which result would weaken the claim?",
    displayText: "Claim: The new pencil grip always improves handwriting speed. Data: Without grip = 18 words/min. With grip = 16 words/min.",
    options: [
      "Writing was slower with the grip in this test",
      "Both tests used pencils",
      "Words per minute were measured",
      "The grip was new",
    ],
    answer: "Writing was slower with the grip in this test",
    difficulty: 3,
    visualSummary: "The data does not show faster writing with the grip.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which prediction follows the pattern?",
    displayText: "Water cooling data:\n0 min: 50\u00b0C\n5 min: 44\u00b0C\n10 min: 38\u00b0C",
    options: [
      "After 15 minutes, the water may be cooler",
      "After 15 minutes, the water must be 90\u00b0C",
      "The water will become paper",
      "Time has no connection to temperature",
    ],
    answer: "After 15 minutes, the water may be cooler",
    difficulty: 3,
    visualSummary: "The temperature is decreasing over time.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Why use the same starting line?",
    displayText: "A class compares how far two toy cars roll.",
    options: [
      "So the comparison is fair",
      "So one car gets a head start",
      "So distance is not measured",
      "So the faster car is chosen first",
    ],
    answer: "So the comparison is fair",
    difficulty: 3,
    visualSummary: "The same starting line controls starting position.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "What should the student change in the experiment?",
    displayText: "A student wants to test whether string length changes a pendulum's swing time.",
    options: [
    ...
    difficulty: 4,
    visualSummary: "String length is the independent variable.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which claim is supported by the evidence?",
    displayText: "Sound test:\nNo wall: 70 dB\nFoam wall: 45 dB",
    options: [
      "The foam wall reduced the sound level",
      "The foam wall made sound louder",
      "No sound was measured",
      "The wall changed color",
    ],
    answer: "The foam wall reduced the sound level",
    difficulty: 4,
    visualSummary: "45 dB is lower than 70 dB.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which result is best evidence that surface mattered?",
    displayText: "Toy car distance:\nSmooth floor: 5 m\nCarpet: 2 m",
    options: [
      "The car rolled farther on the smooth floor",
      "The car had wheels",
      "The carpet was soft",
      "The test used a car",
    ],
    answer: "The car rolled farther on the smooth floor",
    difficulty: 4,
    visualSummary: "Distance changed with the surface.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What variable is being changed?",
    displayText: "A student tests how different amounts of salt affect how fast ice melts.",
    options: [
      "The amount of salt",
      "The bowl shape",
      "The word ice",
  ...
  scienceEvidenceBuildQuestion({
    question: "Which evidence best supports the claim?",
    displayText: "Claim: A darker shirt warmed more in sunlight. Data: Black shirt = 32\u00b0C. White shirt = 24\u00b0C.",
    options: [
      "The black shirt had the higher temperature",
      "Both shirts had sleeves",
      "The white shirt was clean",
      "The sun was outside",
    ],
    answer: "The black shirt had the higher temperature",
    difficulty: 4,
    visualSummary: "The dark shirt was warmer in the data.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement is an inference?",
    displayText: "The classroom floor is wet near an open umbrella.",
    options: [
      "The umbrella may have dripped water on the floor",
      "The floor is wet",
      "The umbrella is open",
      "The wet spot is near the umbrella",
    ],
    answer: "The umbrella may have dripped water on the floor",
    difficulty: 4,
    visualSummary: "The statement explains the observations.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What should be measured to answer the question?",
    displayText: "Question: Does ramp height affect how fast a marble rolls?",
    options: [
      "The time the marble takes to roll",
      "The color of the marble",
      "The name of the ramp",
      "The shape of the notebook",
    ],
    answer: "The time the marble takes to roll",
    difficulty: 4,
    visualSummary: "Rolling time is the measured outcome.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Which choice is the best explanation for the results?",
    displayText: "Wet cloth drying test:\nSunny window: 15 minutes\nCloset: 45 minutes",
    options: [
      "The sunny window helped the cloth dry faster",
      "The closet turned the cloth into ice",
      "The cloth in the closet was not wet",
      "Sunlight always stops drying",
    ],
    answer: "The sunny window helped the cloth dry faster",
    difficulty: 5,
    visualSummary: "The cloth dried in less time by the sunny window.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement is strongest and supported by the data?",
    displayText: "Boat test distance:\nBoat A: 2 m\nBoat B: 4 m\nBoat C: 3 m",
    options: [
      "Boat B traveled the farthest in this test",
      "Boat A traveled the farthest",
      "All boats traveled 4 m",
      "Boat C sank before moving",
    ],
    answer: "Boat B traveled the farthest in this test",
    difficulty: 5,
    visualSummary: "Boat B has the greatest distance.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What should stay the same for a fair test?",
    displayText: "A class compares three kinds of soil to see which helps bean plants grow tallest.",
    options: [
    ...
    answer: "The type of bean seed",
    difficulty: 5,
    visualSummary: "Seed type should be controlled while soil changes.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which conclusion is safest?",
    displayText: "One class tested two magnets. Magnet A picked up 12 paper clips. Magnet B picked up 9 paper clips.",
    options: [
      "In this test, Magnet A picked up more paper clips",
      "Magnet A is always the strongest magnet in the world",
      "Magnet B picked up no paper clips",
      "Paper clips cannot be attracted by magnets",
    ],
    answer: "In this test, Magnet A picked up more paper clips",
    difficulty: 5,
    visualSummary: "The safest conclusion stays limited to the test.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence is more reliable?",
    displayText: "Two groups report results from a ramp experiment.",
    options: [
      "Five trials measured with the same method",
      "One guess made before testing",
      "One trial with no distance written down",
      "A favorite answer chosen by the group",
    ],
    answer: "Five trials measured with the same method",
    difficulty: 5,
    visualSummary: "Repeated measured trials are stronger evidence.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is a problem with this test?",
    displayText: "A student compares two markers. Marker A is used on paper, and Marker B is used on cardboard.",
    options: [
      "The markers were tested on different surfaces",
      "Both markers made marks",
      "The student used writing tools",
      "The test had two markers",
    ],
    answer: "The markers were tested on different surfaces",
    difficulty: 5,
    visualSummary: "Different surfaces make the comparison unfair.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which prediction is best supported by the data?",
    displayText: "Plant height:\nWeek 1: 4 cm\nWeek 2: 8 cm\nWeek 3: 12 cm",
    options: [
      "By week 4, the plant may be taller than 12 cm",
      "By week 4, the plant must be 0 cm",
      "The plant will turn into metal",
      "Time never affects height",
    ],
    answer: "By week 4, the plant may be taller than 12 cm",
    difficulty: 5,
    visualSummary: "The plant height is increasing each week.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Why repeat the experiment with new batteries?",
    displayText: "One flashlight test gave a surprising battery-life result.",
    options: [
      "To see whether the result happens again",
      "To make the flashlight look newer",
      "To avoid measuring time",
      "To choose the winner before testing",
    ],
    answer: "To see whether the result happens again",
    difficulty: 5,
    visualSummary: "Repeating checks whether results are reliable.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    ...
    displayText: "A student measures how high a ball bounces.",
    options: [
      "They help reduce the effect of one unusual bounce",
      "They make the ball larger",
      "They prove no measurement is needed",
      "They change every variable at once",
    ],
    answer: "They help reduce the effect of one unusual bounce",
    difficulty: 6,
    visualSummary: "Multiple trials make evidence more dependable.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which average is correct?",
    displayText: "Bounce heights:\nTrial 1: 20 cm\nTrial 2: 22 cm\nTrial 3: 24 cm",
    options: [
      "22 cm",
      "12 cm",
      "44 cm",
    ...
    answer: "22 cm",
    difficulty: 6,
    visualSummary: "20, 22, and 24 average to 22.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which result may be an outlier?",
    displayText: "Paper clip counts picked up by one magnet:\nTrial 1: 21\nTrial 2: 22\nTrial 3: 5\nTrial 4: 20",
    options: [
      "Trial 3",
      "Trial 1",
      "Trial 2",
    ...
    answer: "Trial 3",
    difficulty: 6,
    visualSummary: "5 is far from the other counts near 20.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which claim is best supported?",
    displayText: "Parachute test average fall time:\nSmall parachute: 2 s\nMedium parachute: 4 s\nLarge parachute: 6 s",
    options: [
      "Larger parachutes fell more slowly in this test",
      "Small parachutes fell most slowly",
      "All parachutes fell in 2 seconds",
      "Parachutes changed into kites",
    ],
    answer: "Larger parachutes fell more slowly in this test",
    difficulty: 6,
    visualSummary: "Fall time increased with parachute size.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is the dependent variable?",
    displayText: "A student changes the type of soil and measures how tall bean plants grow.",
    options: [
    ...
    answer: "How tall the bean plants grow",
    difficulty: 6,
    visualSummary: "Plant height is the measured result.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is the independent variable?",
    displayText: "A class changes the height of a ramp and measures toy car distance.",
    options: [
    ...
    answer: "The height of the ramp",
    difficulty: 6,
    visualSummary: "Ramp height is changed on purpose.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which improvement would make the results stronger?",
    displayText: "A student asks only two students which snack the grade likes best.",
    options: [
      "Ask a larger, mixed group of students",
      "Ask only one friend",
      "Change the question after each answer",
      "Ignore students who disagree",
    ],
    answer: "Ask a larger, mixed group of students",
    difficulty: 6,
    visualSummary: "A larger, more representative sample is stronger.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which conclusion avoids exaggerating?",
    displayText: "In one garden test, mulch helped 7 of 10 tomato plants grow taller.",
    options: [
      "In this garden test, most mulched tomato plants grew taller",
      "Mulch always helps every plant in every garden",
      "No unmulched plant can grow",
      "Tomatoes cannot grow without mulch",
    ],
    answer: "In this garden test, most mulched tomato plants grew taller",
    difficulty: 6,
    visualSummary: "The conclusion should match the limited evidence.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Why include a group that gets plain water?",
    displayText: "A class tests whether a new plant food changes growth.",
    options: [
      "It provides a control group for comparison",
      "It makes plant food disappear",
      "It means height does not need to be measured",
      "It proves the plant food works before testing",
    ],
    answer: "It provides a control group for comparison",
    difficulty: 7,
    visualSummary: "A control group shows what happens without the treatment.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which problem makes the conclusion weak?",
    displayText: "A student says a new shoe makes people run faster. One runner used the new shoe on a track, and another used old shoes on grass.",
    options: [
      "The runners used different surfaces",
      "Both runners wore shoes",
      "Running speed was the topic",
      "The shoes had colors",
    ],
    answer: "The runners used different surfaces",
    difficulty: 7,
    visualSummary: "Different surfaces could affect speed.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which data set is most consistent?",
    displayText: "Four groups measured the same pencil.",
    options: [
      "14.8 cm, 14.9 cm, 15.0 cm, 14.9 cm",
      "10 cm, 20 cm, 8 cm, 25 cm",
      "5 cm, 5 cm, 5 cm, 40 cm",
      "1 cm, 30 cm, 2 cm, 29 cm",
    ],
    answer: "14.8 cm, 14.9 cm, 15.0 cm, 14.9 cm",
    difficulty: 7,
    visualSummary: "The consistent measurements are very close together.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is the best response to an unexpected result?",
    displayText: "Most toy car trials were near 6 meters, but one trial was 1 meter.",
    options: [
      "Check the setup and repeat the trial",
      "Change the 1 to 6 without checking",
      "Delete every result",
      "Stop measuring forever",
    ],
    answer: "Check the setup and repeat the trial",
    difficulty: 7,
    visualSummary: "Unexpected values should be investigated.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which choice best separates correlation from causation?",
    displayText: "Students who carry umbrellas are often seen on rainy days.",
    options: [
      "Rain may cause students to carry umbrellas",
      "Umbrellas cause all rain",
      "Students cause clouds by walking",
      "Umbrellas and rain cannot be related",
    ],
    answer: "Rain may cause students to carry umbrellas",
    difficulty: 7,
    visualSummary: "Rain is a likely third factor or cause of umbrella use.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which design best tests whether extra reading practice improves speed?",
    displayText: "A teacher wants a fair comparison.",
    options: [
      "Similar students, same test, one group gets extra practice",
      "Different tests for every student",
      "Practice group gets easier stories too",
      "Only measure students who already read fastest",
    ],
    answer: "Similar students, same test, one group gets extra practice",
    difficulty: 7,
    visualSummary: "A fair design controls other factors and changes practice.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence source is strongest?",
    displayText: "A student wants to know which filter removes more sand from water.",
    options: [
      "Measured sand amounts before and after filtering for several trials",
      "A guess about which filter looks better",
      "A story with no measurements",
      "A label on the filter box only",
    ],
    answer: "Measured sand amounts before and after filtering for several trials",
    difficulty: 7,
    visualSummary: "Repeated direct measurements are strong evidence.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What does the range of these data show?",
    displayText: "Marble roll distances:\nA: 3.1 m\nB: 3.3 m\nC: 3.2 m\nD: 3.4 m",
    options: [
      "The distances are close together",
      "One marble rolled 10 m",
      "All distances are exactly equal",
      "No distance was measured",
    ],
    answer: "The distances are close together",
    difficulty: 7,
    visualSummary: "The values vary only from 3.1 m to 3.4 m.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Which measurement is most precise?",
    displayText: "A student measures how long a string is.",
    options: [
      "18.7 cm",
      "About 19 cm",
    ...
    answer: "18.7 cm",
    difficulty: 8,
    visualSummary: "18.7 cm gives the most exact measurement.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which survey method is least biased?",
    displayText: "A student wants to know which sport the whole grade prefers.",
    options: [
      "Randomly ask students from every class in the grade",
      "Ask only students on the soccer team",
      "Ask only best friends",
      "Ask only students who dislike sports",
    ],
    answer: "Randomly ask students from every class in the grade",
    difficulty: 8,
    visualSummary: "A random sample from the whole grade is less biased.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which conclusion is supported but not too strong?",
    displayText: "Glue test:\nGlue A held 8 blocks. Glue B held 5 blocks.",
    options: [
      "Glue A held more blocks than Glue B in this test",
      "Glue A is always best for every material",
      "Glue B was not tested",
      "Glue has no effect on blocks",
    ],
    answer: "Glue A held more blocks than Glue B in this test",
    difficulty: 8,
    visualSummary: "The claim stays within the evidence.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is the main weakness of this evidence?",
    displayText: "A student tries a study app for one night and says it will help every student learn faster.",
    options: [
      "Only one student and one night were tested",
      "The app has a screen",
      "Studying can be measured",
      "The student has a backpack",
    ],
    answer: "Only one student and one night were tested",
    difficulty: 8,
    visualSummary: "The sample and time period are too small for a broad claim.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which change reduces measurement error?",
    displayText: "Students measure a quickly moving cart with a stopwatch.",
    options: [
      "Repeat the timing and average the results",
      "Start the timer after the cart stops",
      "Round all times to one hour",
      "Use a different rule each time",
    ],
    answer: "Repeat the timing and average the results",
    difficulty: 8,
    visualSummary: "Repeating and averaging can reduce random error.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which factor could be a confounding variable?",
    displayText: "A class compares seed growth in two windows. One window gets more light and also gets more heat.",
    options: [
      "Heat at the window",
      "The measured plant height",
      "The word seed",
      "The ruler markings",
    ],
    answer: "Heat at the window",
    difficulty: 8,
    visualSummary: "Heat changes along with light and could affect growth.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement best explains a model limit?",
    displayText: "A computer model predicts how water flows through a river.",
    options: [
      "The model can help make predictions, but real rivers may have extra factors",
      "The model proves the river can never change",
      "Models are useless if they use numbers",
      "A model river is exactly the same as every real river",
    ],
    answer: "The model can help make predictions, but real rivers may have extra factors",
    difficulty: 8,
    visualSummary: "Models are useful but simplified.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement best describes the trend?",
    displayText: "Exercise and heart rate:\nRest: 80 beats/min\nSlow walk: 95 beats/min\nRun: 135 beats/min",
    options: [
      "Heart rate increased as activity became harder",
      "Heart rate decreased as activity became harder",
      "Heart rate stayed 80 beats/min",
      "Activity had no pattern with heart rate",
    ],
    answer: "Heart rate increased as activity became harder",
    difficulty: 8,
    visualSummary: "The measured heart rate rises with activity level.",
  }),
  ...
  scienceEvidenceBuildQuestion({
    question: "Which conclusion best fits the evidence?",
    displayText: "Students who practiced piano more often also scored higher on a music quiz. The study did not assign practice times or control previous lessons.",
    options: [
      "More practice is linked with higher quiz scores, but other factors may matter",
      "Practice is proven to be the only cause of higher scores",
      "Previous lessons cannot affect scores",
      "The study proves practice has no relationship to scores",
    ],
    answer: "More practice is linked with higher quiz scores, but other factors may matter",
    difficulty: 9,
    visualSummary: "An uncontrolled observational pattern does not prove one cause.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which design best tests whether a bike helmet foam reduces impact force?",
    displayText: "A class can choose one test design.",
    options: [
      "Drop the same mass from the same height onto each foam type and measure force repeatedly",
      "Drop different masses from different heights once",
      "Choose the foam that looks softest",
      "Test one foam indoors and one foam outdoors with different tools",
    ],
    answer: "Drop the same mass from the same height onto each foam type and measure force repeatedly",
    difficulty: 9,
    visualSummary: "This design controls variables and repeats measurements.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What is the best critique of the claim?",
    displayText: "Claim: A new breakfast makes students focus better. Evidence: six students ate it and reported better focus. There was no comparison group.",
    options: [
      "Without a comparison group, other reasons for better focus are possible",
      "Focus can never be studied",
      "Six students always prove a claim",
      "Breakfast cannot affect people",
    ],
    answer: "Without a comparison group, other reasons for better focus are possible",
    difficulty: 9,
    visualSummary: "A comparison group helps rule out other explanations.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which evidence would most strengthen the claim?",
    displayText: "Claim: A new window coating keeps rooms cooler than normal glass.",
    options: [
      "Temperature measurements from many matched rooms with coated and normal glass",
      "A photo of a shiny window",
      "One person saying the room felt nice",
      "The cost of the coating",
    ],
    answer: "Temperature measurements from many matched rooms with coated and normal glass",
    difficulty: 9,
    visualSummary: "Repeated direct temperature data would test the claim.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which result suggests the hypothesis needs revision?",
    displayText: "Hypothesis: More fertilizer always makes flowers taller. Data: 0 g = 10 cm, 5 g = 18 cm, 15 g = 16 cm.",
    options: [
      "Flowers were shorter at 15 g than at 5 g",
      "The 0 g group grew 10 cm",
      "Fertilizer was measured in grams",
      "The plants were flowers",
    ],
    answer: "Flowers were shorter at 15 g than at 5 g",
    difficulty: 9,
    visualSummary: "The trend does not always increase.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Why should the person judging photos not know which treatment was used?",
    displayText: "A class scores how green leaves look after different plant foods.",
    options: [
      "To reduce bias from expectations",
      "To make leaves grow faster",
      "To avoid recording scores",
      "To change the plant food after scoring",
    ],
  ...
  scienceEvidenceBuildQuestion({
    question: "Which explanation fits all the data?",
    displayText: "Sunlight and algae growth:\nLow light: 3 units\nMedium light: 8 units\nVery high light: 6 units",
    options: [
      "Some light helped, but very high light may have reduced growth",
      "More light always increased growth",
      "Light never affected algae",
      "Low light made the most growth",
    ],
    answer: "Some light helped, but very high light may have reduced growth",
    difficulty: 9,
    visualSummary: "Medium light had the most growth.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which data would help test reproducibility?",
    displayText: "One lab reports that a filter removed 95% of particles.",
    options: [
      "Results from other labs using the same filter and method",
      "The color of the lab tables",
      "A drawing of an untested filter",
      "The lunch schedule from test day",
    ],
    answer: "Results from other labs using the same filter and method",
    difficulty: 9,
  ...
  scienceEvidenceBuildQuestion({
    question: "Which claim is most justified by the evidence?",
    displayText: "A randomized test assigns 80 seedlings to extra light and 80 seedlings to normal light. Soil, water, seed type, and pot size are the same. Extra-light seedlings average 22 cm; normal-light seedlings average 17 cm.",
    options: [
      "In this test, extra light caused higher average growth under these conditions",
      "Extra light always makes every seedling exactly 22 cm",
      "Water and soil were not controlled",
      "Normal-light seedlings grew taller on average",
    ],
    answer: "In this test, extra light caused higher average growth under these conditions",
    difficulty: 10,
    visualSummary: "A randomized controlled design supports a causal claim within its tested conditions.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which limitation should be included in the conclusion?",
    displayText: "A glue test compared Glue A on wood blocks with Glue B on plastic blocks.",
    options: [
      "Material type may have affected how well each glue held",
      "The test used glue",
      "Blocks can be counted",
      "Glue cannot be tested",
    ],
    answer: "Material type may have affected how well each glue held",
    difficulty: 10,
    visualSummary: "Different materials create a confounding variable.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which revision best matches the evidence?",
    displayText: "Original claim: More practice always improves every score. Data: 0 minutes = 70%, 20 minutes = 82%, 60 minutes = 81%.",
    options: [
      "Scores increased from 0 to 20 minutes, but did not increase further at 60 minutes in this test",
      "More practice always improved scores",
      "Practice had no relationship to scores",
      "Students with 0 minutes scored highest",
    ],
    answer: "Scores increased from 0 to 20 minutes, but did not increase further at 60 minutes in this test",
    difficulty: 10,
    visualSummary: "The revised claim matches the pattern without overgeneralizing.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which statement best evaluates the evidence?",
    displayText: "Two sources compare air filters. Source A is a controlled test of 500 rooms. Source B is one customer review.",
    options: [
      "The controlled test of 500 rooms is stronger evidence",
      "The customer review is stronger because it is personal",
      "Both sources are exactly equal",
      "No evidence can compare filters",
    ],
    answer: "The controlled test of 500 rooms is stronger evidence",
    difficulty: 10,
    visualSummary: "A large controlled test is stronger than one testimonial.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which analysis best explains the uncertainty?",
    displayText: "Average bridge load:\nDesign A: 12 kg, range 11-13 kg\nDesign B: 14 kg, range 6-22 kg",
    options: [
      "Design B has a higher average but much more variable results",
      "Design A always holds more than Design B",
      "Design B has no uncertainty",
      "The range is not related to consistency",
    ],
    answer: "Design B has a higher average but much more variable results",
    difficulty: 10,
    visualSummary: "A wider range shows more variability.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which change would best isolate the effect of light color?",
    displayText: "A student grows plants under blue light with extra water and red light with less water.",
    options: [
      "Use the same water amount and change only the light color",
      "Change water, soil, pot size, and light color",
      "Measure only the tallest plant",
      "Do not record plant height",
    ],
    answer: "Use the same water amount and change only the light color",
    difficulty: 10,
    visualSummary: "Only light color should change to isolate its effect.",
  }),
  scienceEvidenceBuildQuestion({
    question: "What would most help determine whether a small effect is real rather than random?",
    displayText: "A test shows Filter A removes 2% more particles than Filter B in one trial.",
    options: [
      "Run many trials, use more samples, and compare variation",
      "Pick the filter that looks better",
      "Measure only Filter A once more",
      "Stop before testing Filter B again",
    ],
    answer: "Run many trials, use more samples, and compare variation",
    difficulty: 10,
    visualSummary: "Replication, sample size, and variation help judge small effects.",
  }),
  scienceEvidenceBuildQuestion({
    question: "Which conclusion correctly separates evidence from opinion?",
    displayText: "Data: Solar Oven A reached 92\u00b0C. Solar Oven B reached 84\u00b0C. Opinion: Oven B has a nicer shape.",
    options: [
      "Oven A reached a higher temperature, while nicer shape is an opinion",
      "Oven B worked better because it looked nicer",
      "The nicer-looking oven must be hotter",
      "Temperature is only an opinion",
    ],
    answer: "Oven A reached a higher temperature, while nicer shape is an opinion",
    difficulty: 10,
